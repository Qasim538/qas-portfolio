...
function Experience() {
    return (
        ...
        <VerticalTimeline lineColor="#3e497a"> 
            ...
            <p>Utilised client brand guidelines, technical specs, photography, and supplied text for brands such as Just Eat, Subway, Premier Foods, eBay, Chivas, Bayer, Reckitt Benckiser, Microsoft, Mastercard, TSB and Qatar Financial Centre.</p>
            </VerticalTimelineElement>
            ...
            <p>I completed an intensive and immersive front-end web development boot camp focused on building a solid foundation in HTML, CSS, and JavaScript. Developed proficiency in responsive design principles and gained hands-on experience with popular frameworks like React. Successfully completed a series of challenging individual and group projects, including building fully functional websites and web applications. Received recognition for exceptional problem-solving abilities, attention to detail, and strong collaboration skills within a team-based learning environment. Demonstrated consistent growth and dedication to mastering cutting-edge web development technologies and industry best practices.</p>
            </VerticalTimelineElement>
